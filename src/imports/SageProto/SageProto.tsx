import svgPaths from "./svg-w7npdjwci3";
...
function Group() {
  return (
    <div className="absolute content-stretch flex flex-col h-[730px] items-start left-0 top-0 w-[336.726px]" data-name="Group">
      <Icon />
    </div>
  );
}
...
function Icon2() {
  return (
    <div className="h-[224.838px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 224.462 224.838">
...
function Group2() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[181.31px] pt-[-0.177px] px-[0.011px] size-[224.484px] top-[-60.34px]" data-name="Group">
      <Icon2 />
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="h-[173.022px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 172.668 173.022">
...
function Group3() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[-43.37px] pt-[0.027px] px-[0.203px] size-[173.075px] top-[518.92px]" data-name="Group">
      <Icon3 />
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="h-[96.059px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col h-[95.106px] items-start left-[20.56px] pt-[-0.477px] px-[-0.268px] top-[226.63px] w-[295.599px]" data-name="Container">
      <Icon4 />
    </div>
  );
}
...
function Icon5() {
  return (
    <div className="h-[32.045px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-[31.702px] items-start pt-[-0.171px] px-[-0.07px] relative shrink-0 w-full" data-name="Container">
      <Icon5 />
    </div>
  );
}
...
function Group11() {
  return (
    <div className="absolute content-stretch flex flex-col h-[30.845px] items-start left-[34.64px] pt-[-0.428px] px-[-0.428px] top-[260.48px] w-[27.418px]" data-name="Group">
      <Container2 />
    </div>
  );
}
...
function Icon6() {
  return (
    <div className="h-[42.412px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col h-[42.84px] items-start pt-[0.214px] px-[-0.086px] relative shrink-0 w-full" data-name="Container">
      <Icon6 />
    </div>
  );
}
...
function Group12() {
  return (
    <div className="absolute content-stretch flex flex-col h-[41.984px] items-start left-[69.18px] pt-[-0.428px] px-[-0.428px] top-[249.73px] w-[27.418px]" data-name="Group">
      <Container3 />
    </div>
  );
}
...
function Icon7() {
  return (
    <div className="h-[26.861px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col h-[26.561px] items-start pt-[-0.15px] px-[-0.07px] relative shrink-0 w-full" data-name="Container">
      <Icon7 />
    </div>
  );
}
...
function Group13() {
  return (
    <div className="absolute content-stretch flex flex-col h-[25.704px] items-start left-[103.71px] pt-[-0.428px] px-[-0.428px] top-[265.64px] w-[27.418px]" data-name="Group">
      <Container4 />
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="h-[21.602px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col h-[21.42px] items-start pt-[-0.091px] px-[-0.07px] relative shrink-0 w-full" data-name="Container">
      <Icon8 />
    </div>
  );
}
...
function Group14() {
  return (
    <div className="absolute content-stretch flex flex-col h-[20.563px] items-start left-[138.25px] pt-[-0.428px] px-[-0.428px] top-[270.84px] w-[27.418px]" data-name="Group">
      <Container5 />
    </div>
  );
}
...
function Icon9() {
  return (
    <div className="h-[29.41px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col h-[29.131px] items-start pt-[-0.139px] px-[-0.086px] relative shrink-0 w-full" data-name="Container">
      <Icon9 />
    </div>
  );
}
...
function Group15() {
  return (
    <div className="absolute content-stretch flex flex-col h-[28.275px] items-start left-[172.79px] pt-[-0.428px] px-[-0.428px] top-[263.08px] w-[27.418px]" data-name="Group">
      <Container6 />
    </div>
  );
}
...
function Icon10() {
  return (
    <div className="h-[37.228px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container7() {
  return (
    <div className="content-stretch flex flex-col h-[36.843px] items-start pt-[-0.193px] px-[-0.07px] relative shrink-0 w-full" data-name="Container">
      <Icon10 />
    </div>
  );
}
...
function Group16() {
  return (
    <div className="absolute content-stretch flex flex-col h-[35.986px] items-start left-[207.32px] pt-[-0.428px] px-[-0.428px] top-[255.32px] w-[27.418px]" data-name="Group">
      <Container7 />
    </div>
  );
}
...
function Icon11() {
  return (
    <div className="h-[44.961px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col h-[44.554px] items-start pt-[-0.203px] px-[-0.086px] relative shrink-0 w-full" data-name="Container">
      <Icon11 />
    </div>
  );
}
...
function Group17() {
  return (
    <div className="absolute content-stretch flex flex-col h-[43.697px] items-start left-[241.84px] pt-[-0.428px] px-[-0.428px] top-[247.6px] w-[27.418px]" data-name="Group">
      <Container8 />
    </div>
  );
}
...
function Icon12() {
  return (
    <div className="h-[0.868px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container9() {
  return (
    <div className="absolute content-stretch flex flex-col h-0 items-start left-[34.7px] pt-[-0.429px] px-[-0.161px] top-[292.37px] w-[267.324px]" data-name="Container">
      <Icon12 />
    </div>
  );
}
...
function Icon13() {
  return (
    <div className="h-[18.175px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col h-[17.993px] items-start pt-[-0.091px] px-[-0.043px] relative shrink-0 w-full" data-name="Container">
      <Icon13 />
    </div>
  );
}
...
function Group20() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[20.78px] pt-[-0.428px] px-[-0.428px] size-[17.136px] top-[328.73px]" data-name="Group">
      <Container10 />
    </div>
  );
}
...
function Icon14() {
  return (
    <div className="h-[18.164px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      <div className="absolute inset-[2.38%_2.21%]" data-name="Vector">
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col h-[17.993px] items-start pt-[-0.086px] px-[-0.043px] relative shrink-0 w-full" data-name="Container">
      <Icon14 />
    </div>
  );
}
...
function Group23() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[20.78px] pt-[-0.428px] px-[-0.428px] size-[17.136px] top-[358.15px]" data-name="Group">
      <Container11 />
    </div>
  );
}
...
function Group26() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[20.78px] pt-[-0.428px] px-[-0.428px] size-[17.136px] top-[387.57px]" data-name="Group">
      <Container12 />
    </div>
  );
}
...
function Group29() {
  return (
    <div className="absolute content-stretch flex flex-col h-[39.413px] items-start left-[20.56px] pt-[-0.193px] px-[0.139px] top-[434.39px] w-[295.599px]" data-name="Group">
      <Icon16 />
    </div>
  );
}
...
function Icon17() {
  return (
    <div className="h-[38.899px] overflow-clip relative shrink-0 w-full" data-name="Icon">
...
function Container13() {
  return (
    <div className="absolute content-stretch flex flex-col h-[37.7px] items-start left-[20.56px] pt-[-0.6px] px-[-0.268px] top-[481.09px] w-[295.599px]" data-name="Container">
      <Icon17 />
    </div>
  );
}
...
function Group32() {
  return (
    <div className="absolute content-stretch flex flex-col h-[53.979px] items-start left-0 pt-[0.161px] top-[676.18px] w-[336.726px]" data-name="Group">
      <Icon18 />
    </div>
  );
}
...
function Container14() {
  return (
    <div className="absolute content-stretch flex flex-col h-0 items-start left-0 pt-[-0.43px] top-[676.34px] w-[336.726px]" data-name="Container">
      <Icon19 />
    </div>
  );
}
...
function Group35() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[31.53px] pt-[-0.016px] px-[-0.021px] size-[4.284px] top-[720.96px]" data-name="Group">
      <Icon20 />
    </div>
  );
}
...
function Group38() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[98.88px] pt-[-0.016px] px-[-0.021px] size-[4.284px] top-[720.96px]" data-name="Group">
      <Icon21 />
    </div>
  );
}
...
function Group41() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[166.22px] pt-[-0.016px] px-[-0.021px] size-[4.284px] top-[720.96px]" data-name="Group">
      <Icon22 />
    </div>
  );
}
...
function Group44() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[233.57px] pt-[-0.016px] px-[-0.021px] size-[4.284px] top-[720.96px]" data-name="Group">
      <Icon23 />
    </div>
  );
}
...
function Group47() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[300.91px] pt-[-0.016px] px-[-0.021px] size-[4.284px] top-[720.96px]" data-name="Group">
      <Icon24 />
    </div>
  );
}

function Sage01Onboarding() {
  return (
    <div className="absolute h-[730px] left-0 top-0 w-[336.726px]" data-name="Sage01Onboarding">
      <Group />
      <Group1 />
      <Group2 />
      <Group3 />
...
function ButtonStep() {
  return <div className="absolute h-[31.702px] left-[20.86px] top-[325.06px] w-[151.655px]" data-name="Button - Step 1" />;
}

function ButtonStep1() {
  return <div className="absolute h-[31.702px] left-[20.86px] top-[354.25px] w-[151.655px]" data-name="Button - Step 2" />;
}

function ButtonStep2() {
  return <div className="absolute h-[31.702px] left-[20.86px] top-[383.46px] w-[151.655px]" data-name="Button - Step 3" />;
}

function ButtonSetMyFirstGoal() {
  return <div className="absolute h-[39.413px] left-[20.56px] top-[434.38px] w-[295.599px]" data-name="Button - Set my first goal" />;
}

function ButtonSkipForNow() {
  return <div className="absolute h-[37.7px] left-[20.56px] top-[481.08px] w-[295.599px]" data-name="Button - Skip for now" />;
}

function Container() {
  return (
    <div className="absolute h-[730px] left-[348.84px] top-[-0.2px] w-[336.726px]" data-name="Container">
      <Sage01Onboarding />
      <ButtonStep />
      <ButtonStep1 />
      <ButtonStep2 />
      <ButtonSetMyFirstGoal />
      <ButtonSkipForNow />
    </div>
  );
}
...
export default function SageProto() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start pr-[-0.4px] relative size-full" data-name="SAGE PROTO">
      <App />
    </div>
  );
}